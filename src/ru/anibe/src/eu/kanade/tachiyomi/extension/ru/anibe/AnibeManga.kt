...
class Selfmanga : ParsedHttpSource() {
    ...
    override fun popularMangaRequest(page: Int) = GET("$baseUrl/posts?limit=25&sort=-rating&page=$page")

    override fun popularMangaParse(response: Response) = searchMangaParse(response)

    override fun latestUpdatesRequest(page: Int) = GET("$baseUrl/posts?limit=25&sort=-updateAt&page=$page")
