...
class Customizable : ConfigurableSource, Madara("Customizable", "", "other") {
    ...
    companion object {
        ...
        private const val BASE_URL_PREF_TITLE = "Example URL: https://domain.com"
        private const val BASE_URL_PREF = "overrideBaseUrl_v${BuildConfig.VERSION_NAME}"
        private const val BASE_URL_PREF_SUMMARY = "Connect to a designated Madara server"
