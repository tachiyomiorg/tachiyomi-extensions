...
open class NineHentai : ParsedHttpSource() {
    ...
    override fun chapterListRequest(manga: SManga): Request {
        val mangaId = manga.url.substringAfter("/g/").toInt()
    ...
    override fun searchMangaRequest(page: Int, query: String, filters: FilterList): Request {
        ...
        for (filter in if (filters.isEmpty()) getFilterList() else filters) {
            when(filter){
                ...
                is Sorting -> {
                    sort = arrayOf(0, 1, 2, 3, 4)[filter.state!!.index]
                }
            }
        }
    ...
    private fun buildRequestBody(searchText: String = "", page: Int = 0, sort: Int = 0, includedTags: MutableList<Tag> = arrayListOf(), excludedTags: MutableList<Tag> = arrayListOf()): RequestBody {
