...
do 
  ...
  do
   ...
   #   cat src/$langcode/$shrtname/build.gradle
      ...
      echo -e "<img src=\"$BlobURL/$image?raw=true\" width=\"60\" alt=\"$name\">" >> Extensions.md
      echo -e "</a>" >> Extensions.md
      echo -e "<img/>" "</td>" >> Extensions.md
      echo -e "<td> " >> Extensions.md
      echo -e "<a href=\"$TreeURL/$langcode/$shrtname\">" >> Extensions.md
      echo -e "\n\n**${name}**\n\n </td>" >> Extensions.md
      echo -e "</a>" >> Extensions.md
      echo -e "</tr>" "<tr>" >> Extensions.md
      echo -e "<td> \n\n*"${version}"*\n\n </td>" >> Extensions.md
      echo -e "</tr>" "</table>" >> Extensions.md
  done
done
