       miraclescans.com
        ...
        neumanga.tv
        manga-zen.com
        olaoe.giize.com -url shortener
        matakomik.com -plex server
        faworeader.altervista.org
        azbivo.webd.pro
        atm-subs.fr
        just-for-fun.ru
        mangazuki.online
        spookyscanlations.xyz
        alianzamarcial.xyz
        www.komikindo.web.id
        komikru.com
        andromedax.net
        primemanga.com
        einherjarscans.space
        nazarickscans.com
...
class MadaraGenerator : ThemeSourceGenerator {
    ...
    override val sources = listOf(
            ...
            SingleLang("MangaDods", "https://www.mangadods.com", "en", overrideVersionCode = 1),
            ...
            SingleLang("WebNovel", "https://webnovel.live", "en", className = "WebNovelLive", overrideVersionCode = 2),
