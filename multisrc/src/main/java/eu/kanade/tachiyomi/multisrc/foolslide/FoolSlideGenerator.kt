...
class FoolSlideGenerator : ThemeSourceGenerator {
    ...
    override val sources = listOf(
            ...
            SingleLang("Anata no Motokare", "https://motokare.xyz", "en"),
            SingleLang("Yuri-ism", "https://www.yuri-ism.net", "en"),
            SingleLang("Ajia no Scantrad", "https://www.ajianoscantrad.fr", "fr"),
            SingleLang("Storm in Heaven", "https://www.storm-in-heaven.net", "it"),
            ...
            SingleLang("HNI-Scantrad", "https://hni-scantrad.com", "fr"),
            SingleLang("HNI-Scantrad", "https://hni-scantrad.com", "en"),
            SingleLang("The Phoenix Scans", "https://www.phoenixscans.com", "it"),
            SingleLang("GTO The Great Site", "https://www.gtothegreatsite.net", "it"),
            SingleLang("Fall World Reader", "https://faworeader.altervista.org", "it"),
