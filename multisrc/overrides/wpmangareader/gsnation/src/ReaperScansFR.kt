...
class ReaperScansFR : WPMangaReader("ReaperScans.fr", "https://reaperscans.fr/", "fr", dateFormat = SimpleDateFormat("MMMM dd, yyyy", Locale.FRANCE)) {

    // Formerly "GS Nation"
    override val id = "8953394032396297337"
